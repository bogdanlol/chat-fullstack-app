...
export default class Channel {
    ...
    removeOne(id,memberId){
            return new Promise((resolve,reject)=>{
                const myquery ={_id:new ObjectID(id)};
                const newValues ={$pull:{members:new ObjectID(memberId)}};
                
                this.app.db.collection('channels').update(myquery,newValues,function(err,res){
