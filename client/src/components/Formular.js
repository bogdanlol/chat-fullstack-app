...
export default class Formular extends Component {
    ...
    onSubmit(event) {
        ...
        this.setState({
            ...
            if(isLogin){
                control.login(user.email, user.password).then((user) => {
                ...
                control.Inregistrare(user).then((_)=> {

                    this.setState({
                        message: {
                            body: 'Utilizator creeat',
                            type: 'success'
                        }
                    }, () => {
                        ...
                        control.login(user.email, user.password).then(() => {
        ...
        return (
            ...
            <div className="user-form" ref={(ref) => this.ref = ref}>
                ...
                <form onSubmit={this.onSubmit} method="post">
                    ...
                    {!isLogin ?  <div className="itemForm">
                        <label>Name</label>
                    ...
                    <div className="formAct">
                        ...
                        <button className="primary" type="submit">{isLogin ? 'Login' : 'Cont Nou'}</button>
                    </div>
                </form>
            </div>
